...
export default function DomeGallery({
  ...
  const cssStyles = `
    ...
    .sphere-item {
      ...
      /* --offset-x, --offset-y, --item-size-x, --item-size-y are set per-tile via style prop (CSS custom properties only) */
    }
    ...
    /* --- dynamic-value classes (use CSS custom properties set on root) --- */
    .dg-main {
      touch-action: none;
  ...
  return (
    <>
      ...
      >
        <main
          ref={mainRef}
          className="dg-main absolute inset-0 grid place-items-center overflow-hidden select-none bg-transparent"
        >
          <div className="stage">
            <div ref={sphereRef} className="sphere">
              {items.map((it, i) => (
                ...
                >
                  <div
                    className="dg-tile-img item__image absolute block overflow-hidden cursor-pointer bg-gray-200 transition-transform duration-300"
                    role="button"
                    tabIndex={0}
          ...
          <div className="dg-vignette absolute inset-0 m-auto z-[3] pointer-events-none" />
          {/* Blur mask ring */}
          <div className="dg-blur-ring absolute inset-0 m-auto z-[3] pointer-events-none" />
          {/* Top gradient */}
          <div className="dg-gradient-top absolute left-0 right-0 top-0 h-[120px] z-[5] pointer-events-none rotate-180" />
          {/* Bottom gradient */}
          <div className="dg-gradient-bottom absolute left-0 right-0 bottom-0 h-[120px] z-[5] pointer-events-none" />

          {/* Viewer / lightbox frame */}
          <div
            ref={viewerRef}
            className="dg-viewer absolute inset-0 z-20 pointer-events-none flex items-center justify-center"
          >
            <div
              ref={scrimRef}
              className="dg-scrim scrim absolute inset-0 z-10 pointer-events-none opacity-0 transition-opacity duration-500"
            />
            <div
              ref={frameRef}
              className="dg-frame viewer-frame h-full aspect-square flex"
            />
          </div>
        </main>
      </div>
